...
Rails.application.configure do
  ...
  # credentials (and other encrypted files). config.require_master_key = true
  ...
  # delivery errors. config.action_mailer.raise_delivery_errors = false
